...
{{-- Fill in the Blank Question Component --}}
@php
    // 1. Escape HTML for safety, then preserve new lines
    $text = nl2br(e($question->question_text));
    ...
    if (preg_match('/_{3,}|\.{3,}|\[blank\]/i', $text)) {
        ...
        $formattedText = $text . '<br><br>' . $inputHtml;
    }
@endphp
<div class="text-white font-medium text-lg leading-relaxed p-4 bg-white/5 rounded-xl border border-white/10 shadow-sm" dir="auto">
    {!! $formattedText !!}
</div>
