...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', __('quiz.nav_dashboard')); ?> — <?php echo e(__('quiz.admin_panel')); ?></title>
...
<body class="min-h-screen bg-dark text-white font-sans antialiased">
    <div class="flex min-h-screen">
        ...
        <aside id="sidebar" class="fixed inset-y-0 z-40 w-64 bg-dark-lighter border-white/5 transition-transform duration-300 <?php echo e(app()->getLocale() === 'ar' ? '' : 'left-0 border-r -translate-x-full lg:translate-x-0'); ?>">
                ...
                <div class="px-6 py-6 border-b border-white/5">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-3 group">
                        <?php if(!empty($system_settings['logo'])): ?>
                            <img src="<?php echo e('/files/' . $system_settings['logo']); ?>" alt="Logo" class="w-10 h-10 object-contain rounded-xl">
                        <?php else: ?>
                        ...
                        <?php endif; ?>
                        <span class="text-2xl font-black text-white tracking-wide shadow-sm" style="font-family: 'Cairo', 'Noto Kufi Arabic', sans-serif;"><?php echo e(isset($system_settings['site_name']) ? $system_settings['site_name'] : 'أجيال المستقبل'); ?></span>
                    </a>
                </div>
                ...
                <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                    <a href="<?php echo e(route('admin.dashboard')); ?>"
                       class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200
                              <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-primary/15 text-primary-light border border-primary/20' : 'text-gray-400 hover:text-white hover:bg-white/5'); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/></svg>
                        <?php echo e(__('quiz.nav_dashboard')); ?>

                    </a>
                    <a href="<?php echo e(route('admin.quizzes.index')); ?>"
                       class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200
                              <?php echo e(request()->routeIs('admin.quizzes.*') ? 'bg-primary/15 text-primary-light border border-primary/20' : 'text-gray-400 hover:text-white hover:bg-white/5'); ?>">
                        ...
                        <?php echo e(__('quiz.nav_quizzes')); ?>

                    </a>
                    <a href="<?php echo e(route('admin.results.index')); ?>"
                       class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200
                              <?php echo e(request()->routeIs('admin.results.*') ? 'bg-primary/15 text-primary-light border border-primary/20' : 'text-gray-400 hover:text-white hover:bg-white/5'); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                        <?php echo e(__('quiz.nav_results')); ?>
                    ...
                    <div class="pt-4 mt-4 border-t border-white/5">
                        ...
                        class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200
                                <?php echo e(request()->routeIs('admin.profile.*') ? 'bg-primary/15 text-primary-light border border-primary/20' : 'text-gray-400 hover:text-white hover:bg-white/5'); ?>">
                            ...
                            <?php echo e(__('quiz.profile_settings') ?? 'Account Settings'); ?>
                        ...
                        class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200 mt-2
                                <?php echo e(request()->routeIs('admin.settings.*') ? 'bg-primary/15 text-primary-light border border-primary/20' : 'text-gray-400 hover:text-white hover:bg-white/5'); ?>">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path></svg>
                            <?php echo e(__('quiz.system_settings') ?? 'System Settings'); ?>
                ...
                <div class="px-4 py-4 border-t border-white/5 space-y-3">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-sm text-gray-400"><?php echo e(auth()->user()->name ?? 'Admin'); ?></span>
                        </div>
                        <form action="<?php echo e(route('logout')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="text-gray-500 hover:text-danger transition-colors" title="<?php echo e(__('quiz.logout')); ?>">
        ...
        <div class="flex-1 main-content <?php echo e(app()->getLocale() === 'ar' ? '' : 'lg:ml-64'); ?>">
            ...
            <header class="lg:hidden bg-dark-lighter/80 backdrop-blur-lg border-b border-white/5 sticky top-0 z-20">
                <div class="flex items-center justify-between px-4 py-3">
                    ...
                    <span class="text-xl font-black text-white" style="font-family: 'Cairo', 'Noto Kufi Arabic', sans-serif;"><?php echo e(isset($system_settings['site_name']) ? $system_settings['site_name'] : 'Quizez'); ?></span>
                    <div class="w-6"></div>
                </div>
            </header>
            ...
            <?php if(session('success')): ?>
                <div id="toast-success" class="fixed top-6 z-50 animate-slide-up toast-position <?php echo e(app()->getLocale() === 'ar' ? 'left-6' : 'right-6'); ?>">
...
<?php /**PATH /home/u783610222/domains/ajyalfuture.com/public_html/quiz/resources/views/layouts/admin.blade.php ENDPATH**/ ?>